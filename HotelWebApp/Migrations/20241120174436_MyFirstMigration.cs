...
namespace HotelWebApp.Migrations
{
    ...
    public partial class MyFirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    booked_from = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    booked_until = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_room", x => x.id);
                    table.ForeignKey(
                        name: "FK_user_room_AspNetUsers_user",
                        column: x => x.user,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_user_room_room_room",
                        column: x => x.room,
                        principalTable: "room",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_room_room",
                table: "user_room",
                column: "room");

            migrationBuilder.CreateIndex(
                name: "IX_user_room_user",
                table: "user_room",
                column: "user");
        }
